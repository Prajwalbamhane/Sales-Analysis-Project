...
Diwali Sales Analysis: Customer Purchase Behavior & Revenue Insights Dashboard
...
🐍 Python – Core programming language used for analysis and data processing.
📊 Pandas – Data manipulation, cleaning, aggregation, and exploratory analysis.
📈 Matplotlib – Data visualization for charts and graphical insights.
🎨 Seaborn – Statistical data visualization and trend analysis.
🧹 Data Cleaning & Transformation – Handling missing values, dropping unnecessary columns, and data type optimization.
...
The dataset contains customer transaction records collected during Diwali sales campaigns and includes information such as:

Customer demographics (Gender, Age Group, Marital Status)
Geographic details (State)
Occupation categories
Product categories and product IDs
Number of orders
Purchase amount and sales values
...
Which customer demographics contribute the highest sales?
...
Reveals purchasing trends across demographics.
Supports targeted marketing campaigns.
Helps businesses optimize inventory and promotional strategies.
